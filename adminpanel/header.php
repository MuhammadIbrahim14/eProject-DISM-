                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        ...
                                        <div class="collapse" id="roles">
                                            <ul class="nav nav-collapse subnav">
                                                <li class="<?php echo $current_page == 'addRoles.php' ? 'active' : ''; ?>">
                                                    <a href="addRoles.php">
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        ...
                                        <div class="collapse" id="category">
                                            <ul class="nav nav-collapse subnav">
                                                <li class="<?php echo $current_page == 'add-Fproduct.php' ? 'active' : ''; ?>">
                                                    <a href="add-Fproduct.php">
                                                        <span class="sub-item">Add Female Product</span>
                                                    </a>
                                                </li>
                                                <li class="<?php echo $current_page == 'add-Mproduct.php' ? 'active' : ''; ?>">
                                                    <a href="add-Mproduct.php">
                                                        <span class="sub-item">Add Male Product</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="collapse" id="products">
                                            <ul class="nav nav-collapse subnav">
                                                <li class="<?php echo $current_page == 'addCategory.php' ? 'active' : ''; ?>">
                                                    <a href="addCategory.php">
                                                        <span class="sub-item">Add Category</span>
                                                    </a>
                                                </li>
                                                <li class="<?php echo $current_page == 'viewCategory.php' ? 'active' : ''; ?>">
                                    ...
                                    <li>
                                        ...
                                        <div class="collapse" id="brand">
                                            <ul class="nav nav-collapse subnav">
                                                <li class="<?php echo $current_page == 'addBrand.php' ? 'active' : ''; ?>">
                                                    <a href="addBrand.php">
                                                        <span class="sub-item">Add Brand</span>
                                                    </a>
                                                </li>
                                                <li class="<?php echo $current_page == 'viewBrand.php' ? 'active' : ''; ?>">
                                                    <a href="viewBrand.php">
                                                        <span class="sub-item">View Brand</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="tables/datatables.html">
                                    <span class="sub-item">Inventory Usage</span>
                                </a>
                            </li>
                            <li>
                                <a href="tables/datatables.html">
                                    <span class="sub-item">Staff Performance</span>
                                </a>
                            </li>
                            <li>
                                <a href="tables/datatables.html">
                                    <span class="sub-item">Trends</span>
                                </a>
                            </li>
                        </ul>
                    </div>
