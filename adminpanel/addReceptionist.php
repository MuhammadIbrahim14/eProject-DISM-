  ...
  <div class="bg-light rounded h-100 p-4">
    ...
    <form method="post">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control border border-3" placeholder="Recetionist" disabled>
      </div>
...
if (isset($_POST['signup_btn'])) {
    ...
    $insert_data = "INSERT INTO users(first_name, last_name, username, email, gender, password, contact_no, dob, role_id)
    VALUES('$firstname', '$lastname', '$username', '$email', '$gender', '$hashed_password', '$contact_no', '$dob', '$role_id')";
