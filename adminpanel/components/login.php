...
//             header("location: adminpanel/index_Receptionist.php");
//         } else if ($fetch['role_id'] == 3) {
//             header("location: adminpanel/index_Stylist.php");
//         } else if ($fetch['role_id'] == 4) {
...
if(isset($_POST['loginBtn'])){
   ...
   $check =  "SELECT * FROM clients WHERE username = '$username' AND password = '$password'";
                    ...
                    <form action="" method="post">
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <div class="form-floating mb-4">
                                <input name="password" type="password" class="form-control" id="sp" placeholder="Password">
