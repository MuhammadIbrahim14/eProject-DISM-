...
<div class="col-sm-6 col-xl-4" style="margin: 100px;">
    <div class="bg-light rounded h-100 p-4">
        <h2 class="mb-4">Add Male Products</h2>
...
if (isset($_POST['Product_btn'])) {
    ...
    $directory = 'product_images/M_product/';
    if (!is_dir($directory)) {
    ...
    if (move_uploaded_file($image_tmpname, $location)) {
        $insert_product = "INSERT INTO `mproduct`(`productName`, `productPrice`, `productDescription`, `productImage`, `category_id`, `brand_id`) 
