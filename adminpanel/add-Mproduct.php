...
if (isset($_POST['product_btn'])) {
    ...
    $location = 'product_images/M_product/' . $image_name;

    move_uploaded_file($image_tmpname, $location);

    $insert_product = "INSERT INTO `M_product`(`product_name`, `product_price`, `product_description`, `product_image`, `category_id`, `brand_id`) 
