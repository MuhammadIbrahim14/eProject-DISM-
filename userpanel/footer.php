            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <p class="mb-0"><i class="fas fa-map-marker-alt text-primary me-2"></i> 123 ranking street
    ...
    <!-- Previous icon -->
    <!-- fas fa-phone text-secondary me-2 -->
    <!-- fas fa-envelope text-secondary me-2 -->
    <!-- fas fa-map-marker-alt text-secondary me-2 -->
